...
>>>>>>> 8a4e9a7f2cef9eb2f95bed184a882a1b76afc119
	...
	public void connexionEntreprises() {
		...
		String email = "Entreprise3.test@Entreprise.test"; //scanner.nextLine(); // TODO: 07/05/2021 "
		System.out.println("Veuillez entrer votre mot de passe");
		// String passwordUser = scanner.nextLine();
		String passwordUser = "Entreprise3Test                                             "; // TODO: 07/05/2021
		...
		try {
			...
			if (rs.next()) {
				...
				if (passwordUser.equals(hashedPasswordFromDB)) {
